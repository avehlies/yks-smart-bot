...
export const simpleCommandConfigs: SimpleCommandConfig[] = [
  {
    ...
    response: { type: 'text', content: 'Is that you, Quentin?' },
    requireGuild: true,
  },
  {
    id: 'garm',
    ...
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'garm' },
    requireGuild: true,
  },
  {
    id: 'gorb',
    ...
    akairo: { cooldown: 3600000, ratelimit: 1, category: 'eater-egg' },
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'gorb' },
    requireGuild: true,
  },
  {
    id: 'grog',
    ...
    akairo: { cooldown: 3600000, ratelimit: 1, category: 'eater-egg' },
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'grog' },
    requireGuild: true,
  },
  {
    id: 'cunky',
    ...
    akairo: { cooldown: 3600000, ratelimit: 1, category: 'eater-egg' },
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'cunky' },
    requireGuild: true,
  },
  {
    id: 'bustard',
    ...
    akairo: { cooldown: 3600000, ratelimit: 1, category: 'eater-egg' },
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'bustard' },
    requireGuild: true,
  },
  {
    id: 'cunch',
    ...
    akairo: { cooldown: 3600000, ratelimit: 1, category: 'eater-egg' },
    globalRate: { enabled: true, ttlMs: 1000 * 60 * 60 * 12 },
    response: { type: 'text', content: 'cunch wrap supreme' },
    requireGuild: true,
  },
  {
    id: 'eve',
    ...
    response: { type: 'text', content: 'Who?' },
    requireGuild: true,
  },
  {
    id: 'garth',
